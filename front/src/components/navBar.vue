  ...
  <nav class="navbar is-fixed-top" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
      <router-link class="navbar-item" to="/">
        <img src="../assets/logo_matcha_nav_bar.svg" alt="logo_matcha" id="logo"/>
      </router-link>
    ...
    <div id="navbarBasicExample" class="navbar-menu">
      <div class="navbar-start">
        <div class="buttons">
          ...
          <a class="button is-rounded is-medium is-success" href="#love_pres" v-if="this.$session.exists() === false || userConnect === false">
            Comment ça marche ?
          </a>
          <router-link class="button is-rounded is-medium is-success" to="/search" v-else-if="this.$session.exists() === true || userConnect === true">
            Search
          </router-link>
          <router-link class="button is-rounded is-medium is-success" v-if="this.$session.exists() === true || userConnect === true" to="/history">
            History
          </router-link>
          <router-link class="button is-rounded is-medium is-success" v-if="this.$session.exists() === true || userConnect === true" to="/chat">
            Chat
            <!-- <div id="class-new-notif" v-if="nbNotif">{{ nbNotif.length }}</div> -->
          </router-link>
        </div>
      </div>
    </div>
